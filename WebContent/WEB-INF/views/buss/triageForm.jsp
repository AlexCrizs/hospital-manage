	...
	<form id="triageform" action="${ctx }/buss/triage/${action}" method="post">
		<table class="formTable">
			<tr>
				<td>患者姓名：</td>
				<td>
					<input type="hidden" name="patientId" value="${triage.patient.id }"/>
					<input type="hidden" name="id" value="${triage.id }"/>
					<input id="patientName" name="patientName" readonly="readonly" class="easyui-validatebox" data-options="width: 150" value="${triage.patient.name }"> 
				</td>
			</tr>
			<tr>
				<td>科室：</td>
				<td><input id="deptId" name="deptId" value="${triage.dept.id }"/></td>
			</tr>
			<tr>
				<td>急诊：</td>
				<td>
