			...
			<div id="topbar" class="top-bar">
				<div class="top-bar-left">
					<h1 style="margin-left: 10px; margin-top: 10px; color: #fff">
						医院分诊<span style="color: #3F4752">管理系统</span>
					</h1>
				</div>
				...
				<div id="homePanel"
					...
					<div class="easyui-layout" data-options="fit: true">
						<div data-options="region: 'north', split: false, border: false"
							style="height: 300px;margin-top:256px;">
							<div style="text-align: center;">
								<h1>西北师范大学医院诊所挂号系统</h1>
								<h3>学年论文----马强</h3>
								<h3>
									欢迎大家来到我的github访问：<a href="https://github.com/AlexCrizs" target="_blank">https://github.com/AlexCrizs</a>
								</h3>
							</div>
						</div>
